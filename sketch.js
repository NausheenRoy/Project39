...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("You have failed to keep the planet safe!",canvas.width/2-400,canvas.height/2+100);
  ...
  if(gameState === instruction) {
    ...
    text("  Help the people and Earth and Keep them safe. !",canvas.width/2-300,canvas.height/2-130);
